...
Utility::TextFileSinkBuilder::TextFileSinkBuilder( TextFileSink* sink ) :
    mSink( sink )
{}

Utility::TextFileSinkBuilder& Utility::TextFileSinkBuilder::outputDirectory( const std::string& outputDirectory )
{
...
Utility::TextFileSinkBuilder& Utility::TextFileSinkBuilder::logExtension( const std::string& logExtension )
{
...
Utility::TextFileSinkBuilder& Utility::TextFileSinkBuilder::formatter( std::unique_ptr< LogFormatter > formatter )
{
