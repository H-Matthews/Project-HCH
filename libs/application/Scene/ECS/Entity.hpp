...
/**
 * This Class serves as a wrapper around the entt::entity type so that we don't have to operate
 * directly with the Entt library
 */
...
class Entity {
  public:
    ...
    template <typename T, typename... Args> T& addComponent(Args&&... args) {
        return mEntityManager->mEntityRegistry.emplace<T>(mEntityHandle,
