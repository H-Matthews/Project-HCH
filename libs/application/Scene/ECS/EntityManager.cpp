...
Application::EntityManager::EntityManager( TextureHolder& textures ) :
    mTextures( textures )
{}
...
Application::Entity Application::EntityManager::createPlayerEntity(
    sf::Vector2f initialPosition, sf::Vector2f initialVelocity )
{
    Entity entity( mEntityRegistry.create(), this );
