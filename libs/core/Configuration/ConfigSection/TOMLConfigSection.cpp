...
Core::TOMLConfigSection::TOMLConfigSection(toml::table table) : mTable(std::move(table)) {}
...
std::unique_ptr<Core::ConfigSection>
Core::TOMLConfigSection::getSection(std::string_view name) const {
